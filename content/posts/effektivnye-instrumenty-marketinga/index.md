...
<table class="stack-table">
  <thead>
    <tr><th>Инструмент</th><th>Вариант</th><th>Стоимость</th></tr>
  </thead>
  <tbody>
    <tr><td>Система учета лидов</td><td>CRM или Google/Яндекс Таблица</td><td>0 руб.</td></tr>
    <tr><td>Email-рассылки</td><td>Unisender, Notisend или аналог</td><td>до 1 000 руб./мес</td></tr>
    <tr><td>Веб-аналитика</td><td>Яндекс.Метрика</td><td>0 руб.</td></tr>
  </tbody>
</table>

<div class="insight"><p>Совокупные расходы — не более 3 000 рублей в месяц. Этого контура достаточно для фиксации воронки и проверки маркетинговых гипотез вплоть до оборота 300–400 млн рублей. Масштабирование инструментов запускается только при двукратном росте нагрузки на ручные операции.</p></div>
...
<div class="insight"><p>До внедрения сквозной аналитики система веб-метрики в типичном интернет-магазине отражает менее 52% фактических заказов. После настройки синхронизации удается связать 93% транзакций с источниками переходов.</p></div>

Это позволяет выявить каналы с отрицательным ROMI, перераспределить бюджеты в пользу рентабельных сегментов и снизить зависимость от субъективных оценок.

**B2B-кейс: производитель оборудования.**

Инжиниринговая компания, работавшая одновременно через офлайн-выставки и интернет-каналы, внедрила платформу сквозной аналитики и коллтрекинга за 14 рабочих дней:

<div class="stat-grid">
  <div class="stat-cell"><div class="num">×1,7</div><div class="lbl">Снижение доли нецелевых обращений</div></div>
  <div class="stat-cell"><div class="num">+157%</div><div class="lbl">Рост продаж</div></div>
  <div class="stat-cell"><div class="num">−22%</div><div class="lbl">Отказы на входящих звонках</div></div>
</div>
...
2. Базовый стек — CRM, email, аналитика — не более 3 000 руб. в месяц. При росте нагрузки подключаются платные модули.
3. Интеграция сквозной аналитики обязательна при медийных бюджетах свыше 300 000 руб. в месяц.
